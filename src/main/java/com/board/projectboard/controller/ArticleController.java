...
import com.board.projectboard.request.ArticleRequest;
import com.board.projectboard.response.ArticleResponse;
import com.board.projectboard.response.ArticleWithCommentsResponse;
...
public class ArticleController {
    ...
    public String postNewArticle(ArticleRequest articleRequest) {
        ...
        articleService.saveArticle(articleRequest.toDto(UserAccountDto.of(
                "eoghks", "eoghks1234", "eoghks@mail.com", "Eoghks", "memo", null, null, null, null
        )));
