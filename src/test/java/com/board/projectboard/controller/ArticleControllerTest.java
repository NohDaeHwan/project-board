...
class ArticleControllerTest {
    ...
    @Test
    public void givenPagingAndSortParams_whenSearchingArticlesPage_thenReturnsArticlesView() throws Exception {
        // Given
    ...
    @DisplayName("[view][GET] 게시글 페이지 - 인증 없을 땐 로그인 페이지 이동")
    @Test
    public void givenNothing_whenRequestingArticleView_thenRedirectsToLoginView() throws Exception {
        // Given
        Long articleId = 1L;
    ...
    @WithUserDetails(value = "eoghksTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    ...
    @Test
    void givenNothing_whenRequesting_thenReturnsUpdatedArticleView() throws Exception {
        // Given
        long articleId = 1L;
